...
import { MapPin, Phone, Mail, Github, Linkedin, Lock, Printer } from 'lucide-react';
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              {onAdminClick && (
                <li className="pt-4">
                  ...
                  >
                    <Lock className="w-3 h-3 mr-1" /> Admin Portal
                  </button>
                </li>
              )}
            </ul>
